...
$string['config_overdue'] = 'Show overdue information in progress bar.';
...
$string['overdue'] = 'Completed, overdue: ';
...
$string['why_show_overdue'] = 'Why show overdue information in progress bar?';
$string['why_show_overdue_help'] = '<p> It is possible to show an overdue indicator in case of late activity completions.</p>';
